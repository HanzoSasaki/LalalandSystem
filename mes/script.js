...
const TSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQNCgNfCiiKtwWXHPRlNJidnyDzo1lQ2oq6jJrwW_tphthSn7GcBu9K6FS9abQcjNXcZiULYNqSA7Ds/pub?gid=296557010&single=true&output=tsv";
    ...
    if (projecaoEl) {
        ...
        if (box) {
            box.innerHTML = `
               ...
               Lucro Bruto: ${formatarMoeda(mediaLucroBruto)}<br><br>
               Lucro Líquido: ${formatarMoeda(mediaLucroLiquido)}<br>
    ...
    dados.meses.forEach((mes, index) => {
        ...
        mesDiv.innerHTML = `
            ...
            <div class="detalhes-mes">
                <p>💰 Bruto: ${formatarMoeda(lucroBruto)}</p>
                <p>📊 Lucro Bruto: ${formatarMoeda(margemLimpa)}</p>
